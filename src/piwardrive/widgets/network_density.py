"""Widget visualizing network density."""
...
class NetworkDensityWidget(DashboardWidget):
    """Show approximate network density."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.label = MDLabel(text="Network Density: N/A", halign="center")
    ...
    def update(self) -> None:
        try:
            self.label.text = "Network Density: N/A"
        except Exception as exc:  # pragma: no cover - UI update
            logging.exception("NetworkDensityWidget update failed: %s", exc)
