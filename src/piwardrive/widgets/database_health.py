"""Widget displaying database health metrics."""
...
class DatabaseHealthWidget(DashboardWidget):
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self.label = MDLabel(text="DB Health: N/A", halign="center")
    ...
    def update(self) -> None:
        try:
            self.label.text = "DB Health: N/A"
        except Exception as exc:  # pragma: no cover - UI update
            logging.exception("DatabaseHealthWidget update failed: %s", exc)
