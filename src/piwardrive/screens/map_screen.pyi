...
class MapScreen(Screen):
    ...
    def prefetch_tiles(self, bounds: Sequence[float], zoom: int = 16, folder: str = "/mnt/ssd/tiles", *, concurrency: int | None = None, progress_cb: Callable[[int, int], None] | None = None) -> None: ...
    ...
    def update_orientation(self, orientation: str | None = ..., accel: dict | None = ..., gyro: dict | None = ...) -> None: ...
