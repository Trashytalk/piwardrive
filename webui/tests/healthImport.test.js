...
describe('parseJson', () => {
  it('parses records', async () => {
    const txt = JSON.stringify([{ timestamp: 't', cpu_temp: 1, cpu_percent: 2, memory_percent: 3, disk_percent: 4 }]);
...
describe('parseCsv', () => {
  it('parses records', async () => {
    const csv = 'timestamp,cpu_temp,cpu_percent,memory_percent,disk_percent\n' +
      't,1,2,3,4';
