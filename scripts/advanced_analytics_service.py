        ...
        async with _get_conn() as conn:
                        ...
                        if time_diff > 0:
                            ...
                            if speed > 150:  # Impossible speed (>540 km/h)
                                suspicious_activities.append({
                                    ...
                                    "false_positive": False,
                                    "analyst_notes": "Possible location spoofing \or
                                        device cloning"
                                })
            ...
            for detection in rogue_detections:
                ...
                suspicious_activities.append({
                    ...
                    "description": f"Rogue AP behavior: {channel_changes} channel changes,
                        {encryption_changes} encryption changes",
            ...
            for i, detection in enumerate(detections):
                ...
                if len(cluster_detections) > 1:
                    cluster = {
                        ...
                        "cluster_density": len(cluster_detections) / 0.01,
                            # networks per 100m²
                        "analysis_timestamp": datetime.now().isoformat()
                    }
