...
class DatabaseOptimizer:
    ...
    def create_advanced_indexes(self):
        ...
        advanced_indexes = [
            ...
            ("idx_wifi_bssid_time_compound",
                "wifi_detections",
                "bssid,
                detection_timestamp DESC"),
                
            ("idx_wifi_location_signal_compound",
                "wifi_detections",
                "latitude,
                longitude,
                signal_strength_dbm DESC"),
                
            ("idx_wifi_ssid_encryption_compound",
                "wifi_detections",
                "ssid,
                encryption_type"),
                
            ("idx_wifi_vendor_channel_compound",
                "wifi_detections",
                "vendor_name,
                channel"),
                
            ("idx_wifi_time_channel_compound",
                "wifi_detections",
                "detection_timestamp,
                channel"),
            ...
            ("idx_bt_manufacturer_time_compound",
                "bluetooth_detections",
                "manufacturer_name,
                detection_timestamp DESC"),
                
            ("idx_bt_location_rssi_compound",
                "bluetooth_detections",
                "latitude,
                longitude,
                rssi_dbm DESC"),
                
            ("idx_bt_device_type_compound",
                "bluetooth_detections",
                "device_type,
                manufacturer_name"),
            ...
            ("idx_cellular_network_time_compound",
                "cellular_detections",
                "network_name,
                detection_timestamp DESC"),
                
            ("idx_cellular_tech_signal_compound",
                "cellular_detections",
                "technology,
                signal_strength_dbm DESC"),
                
            ("idx_cellular_location_compound",
                "cellular_detections",
                "mcc,
                mnc,
                lac,
            ...
            ("idx_gps_session_time_compound",
                "gps_tracks",
                "scan_session_id,
                timestamp"),
                
            ("idx_gps_location_accuracy_compound",
                "gps_tracks",
                "latitude,
                longitude,
                accuracy_meters"),
            ...
            # Analytics indexes
            ("idx_analytics_suspicious_date_compound",
                "network_analytics",
                "suspicious_score DESC,
                analysis_date"),
                
            ("idx_analytics_mobility_compound",
                "network_analytics",
                "mobility_score DESC,
                coverage_radius_meters DESC"),
                

            # Cross-table analysis indexes
            ("idx_suspicious_severity_time_compound",
                "suspicious_activities",
                "severity,
                detected_at DESC"),
                
            ("idx_suspicious_type_location_compound",
                "suspicious_activities",
                "activity_type,
                latitude,
                longitude"),
            ...
            ("idx_daily_stats_date_compound",
                "daily_detection_stats",
                "detection_date DESC,
                total_detections DESC"),
                
            ("idx_coverage_grid_density_compound",
                "network_coverage_grid",
                "detection_count DESC,
                unique_networks DESC")
        ]
