...
class PerformanceBaseline:
    ...
    def compare_with_baseline(self,
        ...
        if "database" in current_results["benchmarks"] \and
            "database" in baseline["benchmarks"]:
        ...
        if "async" in current_results["benchmarks"] \and
            "async" in baseline["benchmarks"]:
        ...
        if "memory" in current_results["benchmarks"] \and
            "memory" in baseline["benchmarks"]:
...
async def main():
    ...
    if args.compare:
        ...
        # Compare results
        comparison = baseline_creator.compare_with_baseline(current_results,
            comparison_baseline)
        ...
        # Create new baseline
        _results = await baseline_creator.create_baseline()
