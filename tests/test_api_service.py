...
with patch.dict('sys.modules', {
    ...
    try:
        from piwardrive.service import app, get_system_status, get_wifi_data, start_scan, stop_scan
...
class TestGPSEndpoints:
    ...
    def test_gps_track_data_endpoint(self, mock_client):
        ...
        with patch('piwardrive.service.get_gps_track_data', return_value=mock_track_data):
            mock_client.get.return_value.status_code = 200
...
class TestConfigurationEndpoints:
    ...
    def test_update_config_endpoint(self, mock_client):
        ...
        with patch('piwardrive.service.update_configuration', return_value=mock_updated_config):
    ...
    def test_reset_config_endpoint(self, mock_client):
        ...
        with patch('piwardrive.service.reset_configuration', return_value=mock_default_config):
            mock_client.post.return_value.status_code = 200
...
class TestDataExportEndpoints:
    ...
    def test_export_json_endpoint(self, mock_client):
        ...
        with patch('piwardrive.service.export_data_json', return_value=mock_export_data):
            mock_client.get.return_value.status_code = 200
    ...
    def test_export_gpx_endpoint(self, mock_client):
        ...
        with patch('piwardrive.service.export_data_gpx') as mock_export:
            ...
            mock_client.get.return_value.status_code = 200
            mock_client.get.return_value.headers = {"content-type": "application/gpx+xml"}
...
class TestAPIAuthentication:
    ...
    def test_protected_endpoint_with_token(self, mock_client):
        ...
        with patch('piwardrive.service.verify_token') as mock_verify:
            ...
            mock_client.get.return_value.status_code = 200
            mock_client.get.return_value.json.return_value = {"message": "Access granted"}
...
class TestAPIPerformance:
    ...
    def test_pagination_support(self, mock_client):
        ...
        with patch('piwardrive.service.get_wifi_data_paginated', return_value=mock_data):
            mock_client.get.return_value.status_code = 200
...
class TestAPIIntegration:
    ...
    def test_complete_scan_workflow(self, mock_client):
        ...
        # Check scan status
        status_response_data = {"active": True, "scan_id": "scan_123", "networks_found": 5}
        mock_client.get.return_value.status_code = 200
