...
class TestDFEngine:
    ...
    async def test_engine_start_stop(self):
        ...
        engine.hardware_managers = {"wifi": Mock(), "antenna": Mock()}

        # Mock algorithms
        engine.algorithms = {DFAlgorithm.RSS_TRIANGULATION: Mock()}
...
class TestDFIntegration:
    ...
    def test_configuration_management(self):
        ...
        config_updates = {"enable_logging": False, "log_level": "DEBUG"}
...
def configured_triangulation(sample_access_points):
    ...
    for ap in sample_access_points:
        triangulation.add_access_point(
            ap["bssid"], ap["latitude"], ap["longitude"], ap["tx_power"]
        )
