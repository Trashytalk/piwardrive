...
class TestDatabaseConnection:
    ...
    async def test_database_initialization(self, tmp_path):
        ...
        with patch(
            "piwardrive.core.persistence._db_path",
    ...
    async def test_app_state_update(self, tmp_path):
        ...
        with patch(
            ...
            initial_state = AppState(
                last_screen="Map", last_start="2024-01-01T12:00:00", first_run=True
            )
...
class TestDatabaseErrorHandling:
    ...
    async def test_database_connection_failure(self, tmp_path):
        ...
        with patch(
            "piwardrive.core.persistence._db_path",
            return_value="/invalid/path/db.sqlite",
        ):
