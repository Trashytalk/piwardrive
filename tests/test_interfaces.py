...
class TestDefaultMapService:
    ...
    def test_get_current_position_with_string_coordinates(self):
        ...
        with mock.patch('piwardrive.interfaces.gps_client.get_position') as mock_gps:
            ...
            mock_gps.return_value = ("40.7128", "-74.0060")  # NYC coordinates as strings
    ...
    def test_fetch_access_points_success(self):
        ...
        with mock.patch('piwardrive.interfaces.utils.fetch_kismet_devices') as mock_fetch:
...
class TestSelfTestCollector:
    ...
    def test_collect_success(self):
        ...
        with mock.patch('piwardrive.interfaces.diagnostics.self_test') as mock_self_test:
...
class TestInterfaceIntegration:
    ...
    def test_default_map_service_implements_protocol(self):
        ...
        with mock.patch('piwardrive.interfaces.gps_client.get_position', return_value=None):
            pos = service.get_current_position()
            assert pos is None or isinstance(pos, tuple)
        
        with mock.patch('piwardrive.interfaces.utils.fetch_kismet_devices', return_value=([], [])):
    ...
    def test_real_world_usage_scenario(self):
        ...
        # Mock dependencies
        with mock.patch('piwardrive.interfaces.gps_client.get_position') as mock_gps, \
             mock.patch('piwardrive.interfaces.utils.fetch_kismet_devices') as mock_kismet, \
             mock.patch('piwardrive.interfaces.diagnostics.self_test') as mock_diagnostics:
