...
class TestPasswordSecurity:
    ...
    def test_password_strength_validation(self):
        ...
        weak_passwords = ["123", "password", "abc", "admin"]
...
class TestPathSecurity:
    ...
    def test_sanitize_path_absolute_outside_allowed(self):
        ...
        dangerous_paths = ["/etc/passwd", "/root/sensitive", "/var/log/system.log"]
...
class TestInputValidation:
    ...
    def test_validate_input_safe(self):
        ...
        safe_inputs = ["normal_string", "123456", "user@example.com", "file_name.txt"]
