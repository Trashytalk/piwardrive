...
class TestSpecificWidgets:
    ...
    def test_battery_status_widget(self):
        ...
        with patch(
            "piwardrive.widgets.battery_status.BatteryStatusWidget"
        ) as mock_widget:
            mock_widget_instance = Mock()
    ...
    def test_detection_rate_widget(self):
        ...
        with patch(
            "piwardrive.widgets.detection_rate.DetectionRateWidget"
        ) as mock_widget:
            mock_widget_instance = Mock()
            mock_widget_instance.render.return_value = (
                "<div>Detection Rate: 42/min</div>"
            )
            mock_widget.return_value = mock_widget_instance
    ...
    def test_network_density_widget(self):
        ...
        with patch(
            "piwardrive.widgets.network_density.NetworkDensityWidget"
        ) as mock_widget:
            mock_widget_instance = Mock()
    ...
    def test_database_health_widget(self):
        ...
        with patch(
            "piwardrive.widgets.database_health.DatabaseHealthWidget"
        ) as mock_widget:
            mock_widget_instance = Mock()
...
class TestWidgetRegistry:
    ...
    def test_widget_registry_discovery(self):
        ...
        with patch("piwardrive.widget_manager.os.listdir") as mock_listdir:
            ...
            with patch(
                "piwardrive.widget_manager.importlib.import_module"
            ) as mock_import:
                mock_module = Mock()
                mock_widget_class = Mock()
